document.addEventListener('DOMContentLoaded', () => {
    ...
    const womanTopsProductsContainer = document.getElementById('woman-tops-products');
    ...
    // Function to display woman's tops
    const displayWomanTops = (products) => {
      products.forEach((product) => {
        ...
        womanTopsProductsContainer.appendChild(item);
      });
    };
