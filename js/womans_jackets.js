document.addEventListener('DOMContentLoaded', () => {
    ...
    const womanJacketsProductsContainer = document.getElementById('jackets-items-container');
    ...
    // Function to display woman's jackets
    const displayWomanJackets = (products) => {
        products.forEach((product) => {
            ...
            womanJacketsProductsContainer.appendChild(item);
        });
    };
